...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Laravel ChatGPT | A generative IA content into a web chatbot</title>
  ...
  <body>
        ...
        <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
            <div class="relative flex items-center space-x-4">
                ...
                <div class="flex flex-col leading-tight">
                    ...
                    <span class="text-gray-700 mr-3">Orphéric ALLAGBE</span>
                    </div>
                    <span class="text-lg text-gray-600">Laravel Software Developer</span>
                </div>
            </div>
                ...
                <div class="chat-message">
                    <div class="flex items-end justify-end">
                        <div class="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                            <div>
                                <span class="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">  {{$message->content}} </span>
                            </div>   
                        </div>
                        <img src="{{asset('/img/chatgpt.png')}}" alt="ChatGPT" class="w-6 h-6 rounded-full order-2">
                    </div> 
                </div>
                @endif
        ...
        <!-- Form to send message on ChatGPT  -->
        <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
            <form method="POST" action="{{ route('chat', [$conversation?->id ?? 'new']) }}">
                @csrf
                <div class="relative flex">
                    ...
                    <input type="text" placeholder="Tape your question here!" name="prompt" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3">
